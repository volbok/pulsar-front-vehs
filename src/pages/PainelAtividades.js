    ...
    return (
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
          ...
          <div className="text1" style={{ fontSize: 20 }}>{selectedatividade}</div>
        </div>
        ...
        >
          {atendimentos
            ...
            .filter(item => item.situacao == selectedatividade && moment(item.data_inicio).format('DD/MM/YYYY') == selectdate)
